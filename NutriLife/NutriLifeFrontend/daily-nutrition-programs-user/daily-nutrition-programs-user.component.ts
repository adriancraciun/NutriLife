...
@Component({
  selector: 'app-daily-nutrition-programs-user',
  templateUrl: './daily-nutrition-programs-user.component.html',
  styleUrls: ['./daily-nutrition-programs-user.component.css']
})
export class DailyNutritionProgramsUserComponent implements OnInit {
